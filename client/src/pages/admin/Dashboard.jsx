...
const Dashboard = () => {
  ...
  // FIX #2: Changed 'totalUser' to 'totalUsers' to match backend
  ...
  // FIX #1: Prefixed all values with 'dashboardData.'
  ...
  return !loading ? (
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {/* Note: This should probably map over dashboardData.activeShows, not dummy data */}
        {dashboardData.activeShows.map((show) => (
          <div key={show._id} className='w-55 rounded-lg overflow-hidden h-full
            ...
            <img src={image_base_url + show.movie.poster_path} alt={show.movie.title}

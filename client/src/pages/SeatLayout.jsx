        ...
        <div className='flex flex-wrap items-center justify-center gap-2'>
          {Array.from({length: count},(_, i) =>{
            ...
            return (
              ...
              className={`w-8 h-8 rounded border border-primary/60
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      h-max md:sticky md:top-30'>
        <p className='text-lg font-semibold px-6' >Availabe Timings</p>
        
        <div className='mt-5 space-y-1'>
          {show.dateTime[date].map((item) => (
            <div key={item.time} onClick={()=>setSelectedTime(item.time)} 
      ...
      <div className='relative flex-1 flex flex-col items-center max:md:mt-16'>
        ...
        <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
          <div className='grid grid-cols-1 md:grip-cols-1 gap-8 md:gap-2 mb-6'>
        ...
        <button onClick={() => navigate('/my-bookings')}
          className='flex items-center gap-1 mt-20 px-10 py-3 bg-primary hover:bg-primary-dull

  ...
  return show ?(
    <div className='px-6 md:px-16 lg:px-40 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <img src={show.movie.poster_path} alt='movie poster' className='max-md:mx-auto
        rounded-xl h-104 max-w-70 object-cover'/>
        
        <div className='relative flex flex-col gap-3'>
          <BlurCircle top='-100px' left='-100px'/>
          <p className='text-primary'>English</p>
          <h1 className='text-4xl font-semi-bold max-w-96 text-balance'>{show.movie.title}</h1>
          ...
          <div className='flex items-center gap-2 text-gray-300'>
           ...
           <p className='text-gray-400 max-w-xl mt-2 text-sm leading-tight'>
            {show.movie.overview}
           </p>
           ...
           <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-800
             transition rounded font-medium cursor-pointer active:scale-95'>
        ...
        <div className='flex items-center gap-4 w-max px-4'>
          { show.movie.casts.slice(0,12).map((cast, index) => (
            <div key={index} className='flex flex-col items-center text-center'>
              <img src={cast.profile_path} alt="" className='h-20 md:h-20 aspect-square 
      ...
      <div className= 'flex flex-wrap max-sm justify-center gap-8'>
        ...
        <div className='flex jsutify-center mt-20'>

  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
      ...
      <div className='relative flex items-center justify-between pt-20 pb-10'>
        ...
        <button onClick={() => navigate('/movies')} className=' group flex items-center gap-1 text-sm text-gray-300 cursor-pointer '>
            Explore More
      ...
      <div className='flex justify-center mt-20'>
        ...
        className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull
         transition rounded font-medium cursor-pointer'>
            Show More
        </button>
      </div>
    </div>
